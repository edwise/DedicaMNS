...
public class DayUtils {
	...
	public static List<DayRecord> fillListDaysWithOnlyActivityDay(List<DayRecord> listDays, BatchDataBean batchData) {
	...
	public static String formatHour(String hours) {
		...
		if (hourSplitted.length > 1) {
			hoursFormatted = hoursFormatted + HOUR_MINUTES_SEPARATOR + StringUtils.leftPad(hourSplitted[1], 2, '0');
		} else {
